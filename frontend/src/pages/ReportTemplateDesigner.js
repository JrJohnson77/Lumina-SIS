...
export default function ReportTemplateDesigner({ schoolCodeProp, embedded = false }) {
    ...
    const addElement = (type) => {
        ...
        const defaults = {
            ...
            line:   { config:{orientation:'horizontal'}, styles:{backgroundColor:'#000000'}, width:400, height:2 },
            'vertical-line': { config:{orientation:'vertical'}, styles:{backgroundColor:'#000000'}, width:2, height:200 },
